        ...
        <div className="about-container mb-28 flex mx-auto">
            <div className="about-texts flex text-left flex-col">
                ...
                <div className="about-links flex">
                    ...
                    dark:text-indigo-200 dark:bg-white">
                    ...
                    <a className="w-32 mt-10 mr-5 justify-evenly flex items-center bg-transparent
                     ...
                     hover:bg-indigo-700 text-indigo-700 font-semibold hover:text-white py-2 px-4 border border-indigo-500 hover:border-transparent rounded-md">
