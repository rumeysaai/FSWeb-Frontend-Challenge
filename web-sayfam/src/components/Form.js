...
const Form = () => {
    ...
    const createMessage = () => {
        ...
        emailjs.sendForm('service_m3noxwq', 'template_196b4w9', form.current, 'ApuHxVVJ5c52Ka2iE')
            .then((result) => {
    ...
    return (
        <div className="h-full max-w-screen-xl">
            ...
            <form className="w-full max-w-xl mx-auto pt-8 h-full pb-40" onSubmit={handleSubmit(createMessage)} ref={form} /*onSubmit={sendEmail}*/>
